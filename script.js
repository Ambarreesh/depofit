document.addEventListener("DOMContentLoaded", () => {
    const numbers = [
        { id: "established", finalValue: 1998, addPlus: false },
        { id: "faculties", finalValue: 10, addPlus: true },
        { id: "students", finalValue: 10, addPlus: true },
        { id: "publications", finalValue: 500, addPlus: true },
        { id: "patents", finalValue: 1500, addPlus: true },
        { id: "phds", finalValue: 15, addPlus: true }
    ];

    const overlap = document.querySelector(".overlap-4");

    overlap.addEventListener("mouseenter", () => {
        numbers.forEach(({ id, finalValue, addPlus }) => {
            ...
            let interval = setInterval(() => {
                if (currentValue >= finalValue) {
                    ...
                    element.textContent = addPlus ? finalValue + "+" : finalValue;
                } else {
